(module
 ...
 (func $rc/ternary-mismatch/Ref#constructor (param $0 i32) (result i32)
  local.get $0
  i32.eqz
  if
   i32.const 0
 ...
 (func $rc/ternary-mismatch/getRef (result i32)
  i32.const 0
 ...
 (func $start:rc/ternary-mismatch
  i32.const 0
  call $rc/ternary-mismatch/Ref#constructor
 ...
 (func $rc/ternary-mismatch/Ref~visit (param $0 i32) (param $1 i32)
  nop
 )
 (func $~lib/rt/__visit_members (param $0 i32) (param $1 i32)
  block $invalid
   block $rc/ternary-mismatch/Ref
    block $~lib/arraybuffer/ArrayBufferView
     block $~lib/string/String
      block $~lib/arraybuffer/ArrayBuffer
       ...
       i32.sub
       i32.load
       br_table $~lib/arraybuffer/ArrayBuffer $~lib/string/String $~lib/arraybuffer/ArrayBufferView $rc/ternary-mismatch/Ref $invalid
      end
      local.get $0
      local.get $1
   ...
   local.get $0
   local.get $1
   call $rc/ternary-mismatch/Ref~visit
   return
  end
  unreachable
 )
